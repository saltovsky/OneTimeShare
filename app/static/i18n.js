...
(function () {
    ...
    var T = {
        ru: {
            ...
            'admin.tabLdap':         'LDAP',
            'admin.ldapSaved':       'Настройки LDAP сохранены.',
            'admin.ldapEnable':      'LDAP авторизация',
            'admin.ldapEnableHint':  'Включить вход через LDAP. Пользователи будут создаваться автоматически с ролью uploader.',
            'admin.ldapConnection':  'Подключение к LDAP',
            'admin.ldapConnHint':    'Настройте параметры сервера каталогов для входа пользователей через LDAP.',
            'admin.ldapHost':        'Host',
            'admin.ldapPort':        'Port',
            'admin.ldapProtocol':    'Протокол',
            'admin.ldapBaseDn':      'Base DN',
            'admin.ldapSearchFilter': 'Search filter',
            'admin.ldapSearchFilterHint': 'Используйте {username} как плейсхолдер. Если оставить пустым, будет использован фильтр по атрибуту Login.',
            'admin.ldapBindDn':      'Учётная запись для запросов (Bind DN)',
            'admin.ldapBindDnHint':  'Оставьте пустым для анонимного подключения.',
            'admin.ldapBindPassword':'Пароль учётной записи',
            'admin.ldapAttributes':  'Атрибуты и таймаут',
            'admin.ldapLoginAttr':   'Логин',
            'admin.ldapFullnameAttr':'ФИО',
            'admin.ldapEmailAttr':   'E-mail',
            'admin.ldapTimeout':     'Таймаут (сек)',
            'admin.ldapSave':        'Сохранить',
            'admin.ldapTestConn':    'Проверить соединение',
            'admin.ldapTesting':     'Проверка…',
            'admin.ldapLookup':      'Проверка пользователя',
            'admin.ldapLookupHint':  'Введите логин пользователя, чтобы проверить его наличие в LDAP-каталоге.',
            'admin.ldapLookupBtn':   'Найти',
            'admin.ldapLookupEmpty': 'Введите имя пользователя.',
            'admin.ldapSearching':   'Поиск…',
            'admin.ldapAllAttrs':    'Все атрибуты',
        ...
        en: {
            ...
            'admin.tabLdap':         'LDAP',
            'admin.ldapSaved':       'LDAP settings saved.',
            'admin.ldapEnable':      'LDAP authentication',
            'admin.ldapEnableHint':  'Enable LDAP-based login. Users will be auto-created with the uploader role.',
            'admin.ldapConnection':  'LDAP Connection',
            'admin.ldapConnHint':    'Configure directory server settings for LDAP-based user login.',
            'admin.ldapHost':        'Host',
            'admin.ldapPort':        'Port',
            'admin.ldapProtocol':    'Protocol',
            'admin.ldapBaseDn':      'Base DN',
            'admin.ldapSearchFilter': 'Search filter',
            'admin.ldapSearchFilterHint': 'Use {username} as placeholder. If left empty, a filter based on the Login attribute will be used.',
            'admin.ldapBindDn':      'Service account (Bind DN)',
            'admin.ldapBindDnHint':  'Leave empty for anonymous bind.',
            'admin.ldapBindPassword':'Service account password',
            'admin.ldapAttributes':  'Attributes and timeout',
            'admin.ldapLoginAttr':   'Login',
            'admin.ldapFullnameAttr':'Full name',
            'admin.ldapEmailAttr':   'E-mail',
            'admin.ldapTimeout':     'Timeout (sec)',
            'admin.ldapSave':        'Save',
            'admin.ldapTestConn':    'Test connection',
            'admin.ldapTesting':     'Testing…',
            'admin.ldapLookup':      'User lookup',
            'admin.ldapLookupHint':  'Enter a username to check if it exists in the LDAP directory.',
            'admin.ldapLookupBtn':   'Find',
            'admin.ldapLookupEmpty': 'Please enter a username.',
            'admin.ldapSearching':   'Searching…',
            'admin.ldapAllAttrs':    'All attributes',
